...
public class BYDimen {
	...
	public static int getTextSize(int level) {
		...
		return Math.round(BYResources.getInstance().getDimension(resName));
	}
	...
	public static int getCornerSize() {
		if (sCornerSize == -1) {
			sCornerSize = Math.round(BYResources.getInstance().getDimension("corner_size"));
		}
		return sCornerSize;
	}
	...
	public static int getLineHeight() {
		if (sLineHeight == -1) {
			sLineHeight = Math.round(BYResources.getInstance().getDimension("line_height"));
		}
		return sLineHeight;
	}
	...
	public static int getUnitBgShadowTop() {
		if (sUnitBgShadowTop == -1) {
			sUnitBgShadowTop = Math.round(BYResources.getInstance().getDimension("unit_bg_shadow_top"));
		}
	...
	public static int getUnitBgShadowLeft() {
		if (sUnitBgShadowLeft == -1) {
			sUnitBgShadowLeft = Math.round(BYResources.getInstance().getDimension("unit_bg_shadow_left"));
		}
	...
	public static int getUnitBgShadowRight() {
		if (sUnitBgShadowRight == -1) {
			sUnitBgShadowRight = Math.round(BYResources.getInstance().getDimension("unit_bg_shadow_right"));
		}
	...
	public static int getUnitBgShadowBottom() {
		if (sUnitBgShadowBottom == -1) {
			sUnitBgShadowBottom = (int) BYResources.getInstance().getDimension("unit_bg_shadow_bottom");
		}
	...
	public static int getDialogBtnCornerSize() {
		if (sCornerSize == -1) {
			sCornerSize = (int) BYResources.getInstance().getDimension("dialog_btn_corner_size");
		}
		return sCornerSize;
	}
	...
	public static int getDialogTitleSize() {
		if (sDialogTitleSize == -1) {
			sDialogTitleSize = (int) BYResources.getInstance().getDimension("dialog_title_size");
		}
	...
	public static int getVerticalGap() {
		if (sVerticalGap == -1) {
			sVerticalGap = Math.round(BYResources.getInstance().getDimension("common_vertical_gap"));
		}
		return sVerticalGap;
	}
