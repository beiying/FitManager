...
public class BYResources extends BYBasicContainer {
	
	private static final String TAG = "theme";

	static final String THEME_PACKAGE = "com.lenovo.browser.theme";

	private static BYResources sInstance;
	...
	public static BYResources getInstance() {
		if (sInstance == null) {
			synchronized (BYResources.class) {
				if (sInstance == null) {
					sInstance = new BYResources();
				}
			}
		}
		return sInstance;
