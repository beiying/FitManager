package com.beiying.fitmanager.launchstarter;
...
import com.beiying.fitmanager.launchstarter.sort.TaskSortUtil;
import com.beiying.fitmanager.launchstarter.stat.TaskStat;
import com.beiying.fitmanager.launchstarter.task.DispatchRunnable;
import com.beiying.fitmanager.launchstarter.task.Task;
import com.beiying.fitmanager.launchstarter.task.TaskCallBack;
import com.beiying.fitmanager.launchstarter.utils.DispatcherLog;
...
public class TaskDispatcher {
    ...
    public static void init(Context context) {
        if (context != null) {
            sContext = context;
            sHasInit = true;
            sIsMainProcess = BYAndroidUtils.isMainProcess(sContext);
        }
    }
