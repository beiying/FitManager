...
public class BYTrainingCardView extends LeView {
    ...
    public BYTrainingCardView(final Context context) {
        super(context);
        ...
        mAddTrainBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                BYAllTrainView allTrainView = new BYAllTrainView(context);
                BYControlCenter.getInstance().showInFeatureView(allTrainView, BYFeatureView.createDefaultCallback());
            }
        });
