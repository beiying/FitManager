...
public class PathUtil {
	 ...
	 */
	public static Path createRoundRectPath(float width, float height, float cornerSize) {
		return createRoundRectPath(width, height, 0, 0, 0, 0, cornerSize, true, true, true, true);
	}
	...
	public static Path createRoundRectPath(float width, float height,
		...
		return createRoundRectPath(width, height, xPadding, xPadding,
				yPadding, yPadding, cornerSize, true, true, true, true);
	}
