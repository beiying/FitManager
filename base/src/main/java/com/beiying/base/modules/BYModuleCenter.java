...
import com.beiying.base.modules.template.IModuleUnit;
import com.beiying.base.utils.ClassUtils;
...
public class BYModuleCenter {
    private final static String TAG = "BYModuleCenter";
    ...
    public synchronized static void init(Context context){
        try {
            List<String> classFileNames = ClassUtils.getFileNameByPackageName(context, BYModuleUtil.NAME_OF_MODULEUNIT);  //获取指定ModuleUnit$$的类名的文件
            for (String className:classFileNames){
                if (className.startsWith(BYModuleUtil.ADDRESS_OF_MODULEUNIT)){
