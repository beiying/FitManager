 ...
 */
public abstract class BYSafeRunnable implements Runnable {
	...
	public BYSafeRunnable() {
		this(null);
	}
	
	public BYSafeRunnable(Object data) {
		this(data, true);
	}
	
	public BYSafeRunnable(Object data, boolean checkSafe) {
