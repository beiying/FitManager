...
public class BYBarDataSet extends BYBarLineScatterCandleRadarDataSet<BYBarEntry>{
    ...
    public BYBarDataSet(ArrayList<BYBarEntry> yVals, String label) {
        super(yVals, label);
    ...
    @Override
    public BYDataSet<BYBarEntry> copy() {
        
        ArrayList<BYBarEntry> yVals = new ArrayList<BYBarEntry>();

        for (int i = 0; i < mYVals.size(); i++) {
            yVals.add(((BYBarEntry) mYVals.get(i)).copy());
        }

        BYBarDataSet copied = new BYBarDataSet(yVals, getLabel());
     ...
     */
    private void calcEntryCountIncludingStacks(ArrayList<BYBarEntry> yVals) {
     ...
     * DataSet
     */
    private void calcStackSize(ArrayList<BYBarEntry> yVals) {
