...
public class BYBarEntry extends BYEntry{
     ...
     * @param xIndex
     */
    public BYBarEntry(float[] vals, int xIndex) {
     ...
     * @param xIndex
     */
    public BYBarEntry(float val, int xIndex) {
        super(val, xIndex);
    }
     ...
     */
    public BYBarEntry(float[] vals, int xIndex, String label) {
     ...
     */
    public BYBarEntry(float val, int xIndex, Object data) {
     ...
     */
    public BYBarEntry copy() {

    	BYBarEntry copied = new BYBarEntry(getVal(), getXIndex(), getData());
        copied.mVals = mVals;
        return copied;
    }
