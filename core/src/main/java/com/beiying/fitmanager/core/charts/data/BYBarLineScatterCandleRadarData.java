...
public class BYBarLineScatterCandleRadarData<T extends BYBarLineScatterCandleRadarDataSet<? extends BYEntry>> extends BYChartData<T>{

	/** array of limit-lines that are set for this data object */
    private ArrayList<LimitLine> mLimitLines;
    
    public BYBarLineScatterCandleRadarData(ArrayList<String> xVals) {
        super(xVals);
    }
    
    public BYBarLineScatterCandleRadarData(String[] xVals) {
        super(xVals);
    }

    public BYBarLineScatterCandleRadarData(ArrayList<String> xVals, ArrayList<T> sets) {
        super(xVals, sets);
    }

    public BYBarLineScatterCandleRadarData(String[] xVals, ArrayList<T> sets) {
        super(xVals, sets);
    }
