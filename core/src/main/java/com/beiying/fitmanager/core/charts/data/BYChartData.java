...
public abstract class BYChartData<T extends BYDataSet<? extends BYEntry>> {
    ...
    /**
     * contains the average length (in characters) an entry in the x-vals array has
     * X轴坐标显示字符长度的平均值
     */
    ...
    protected ArrayList<T> mDataSets;//对于LineChart，一个Dataset对应一条折线，该变量的size值为LineChart中的折线条数
     ...
     * @param xVals
     */
    public BYChartData(ArrayList<String> xVals) {
        this.mXVals = xVals;
     ...
     * @param xVals
     */
    public BYChartData(String[] xVals) {
     ...
     */
    public BYChartData(ArrayList<String> xVals, ArrayList<T> sets) {
        this.mXVals = xVals;
        this.mDataSets = sets;
     ...
     * @param sets the dataset array
     */
    public BYChartData(String[] xVals, ArrayList<T> sets) {
        this.mXVals = arrayToArrayList(xVals);
        this.mDataSets = sets;
     ...
     */
    public BYEntry getEntryForHighlight(Highlight highlight) {
     ...
     * @param dataSetIndex
     */
    public void addEntry(BYEntry e, int dataSetIndex) {
     ...
     * @param dataSetIndex
     */
    public boolean removeEntry(BYEntry e, int dataSetIndex) {
    ...
    public boolean removeEntry(int xIndex, int dataSetIndex) {
        ...
        BYEntry e = dataSet.getEntryForXIndex(xIndex);
     ...
     * @return
     */
    public T getDataSetForEntry(BYEntry e) {
