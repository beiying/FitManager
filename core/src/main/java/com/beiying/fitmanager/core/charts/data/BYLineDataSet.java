...
public class BYLineDataSet extends BYLineRadarDataSet<BYEntry> {
    ...
    public BYLineDataSet(ArrayList<BYEntry> yVals, String label) {
        super(yVals, label);
    ...
    public BYDataSet<BYEntry> copy() {
        ...
        BYLineDataSet copied = new BYLineDataSet(yVals, getLabel());
