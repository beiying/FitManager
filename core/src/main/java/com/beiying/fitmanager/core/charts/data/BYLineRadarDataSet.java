...
public abstract class BYLineRadarDataSet<T extends BYEntry> extends BYBarLineScatterCandleRadarDataSet<T> {
...
//    private Shader mShader;
    ...
    public BYLineRadarDataSet(ArrayList<T> yVals, String label) {
        super(yVals, label);
    }
