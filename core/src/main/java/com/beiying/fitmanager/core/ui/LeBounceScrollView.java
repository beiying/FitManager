...
public class LeBounceScrollView extends LeScrollView {
	...
	public LeBounceScrollView(Context context) {
		super(context);
		initView();
	}

	public LeBounceScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
