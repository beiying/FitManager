...
public class LeRoundImageView extends ImageView implements LeThemable {
    ...
    public LeRoundImageView(Context context) {
        super(context);
        init();
        applyTheme();
    }

    public LeRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LeRoundImageView(Context context, AttributeSet attrs, int defStyle) {
...
//        mBorderPaint.setColorFilter(LeColorUtil.getNightColorFilter());
        mBitmapPaint.setColorFilter(LeColorUtil.getNightColorFilter());
        invalidate();
    }
